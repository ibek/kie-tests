...
public class JBPMController {
        ...
        if (persistence) {
            ...
            try {
                ...
                UserTransaction ut = (UserTransaction) context
                        .lookup(JtaTransactionManager.DEFAULT_USER_TRANSACTION_NAME);
    ...
    public RuntimeManager createRuntimeManager(String... process) {
        return createRuntimeManager(
                Strategy.valueOf(JBPMTestConfig.getInstance().getRuntimeManagerStrategy().toUpperCase()), null,
                process);
    }
    ...
    public RuntimeManager createRuntimeManager(Map<String, ResourceType> resources) {
        return createRuntimeManager(
                Strategy.valueOf(JBPMTestConfig.getInstance().getRuntimeManagerStrategy().toUpperCase()), resources,
                null);
    }
    ...
    protected RuntimeManager createRuntimeManager(Strategy strategy, Map<String, ResourceType> resources,
        ...
        builder.addEnvironmentEntry(EnvironmentName.USE_PESSIMISTIC_LOCKING,
                JBPMTestConfig.getInstance().isPessimisticLocking());
